...
<div class="container">
	<h3>Προσθήκη προμηθευτή</h3>
	<form class="form-horizontal" method="post" action="index.php?page=newSupplier&amp;action=new">

		<!-- fullname -->
		<div class="control-group">
			<label class="control-label" for="fullname">Όνομα</label>
			<div class="controls">
				<input type="text" id="fullname" name="fullname" value="<?php echo checkVar($supplier) ? $supplier->fullname : ""; ?>" required>
			</div>
		</div>
		...
		<div class="control-group">
			...
			<div class="controls">
				<input type="number" id="vat" name="vat" value="<?php echo checkVar($supplier) ? $supplier->vat : ""; ?>" required>
			</div>
		</div>
		...
		<div class="control-group">
			...
			<div class="controls">
				<input type="text" id="location" name="location" value="<?php echo checkVar($supplier) ? $supplier->location : ""; ?>" required>
			</div>
		</div>
		...
		<div class="control-group">
			...
			<div class="controls">
				<input type="text" id="phone_number" name="phone_number" value="<?php echo checkVar($supplier) ? $supplier->phone_number : ""; ?>" required>
			</div>
		</div>
		...
		<div class="control-group">
			...
			<div class="controls">
				<input type="text" id="email" name="email" value="<?php echo checkVar($supplier) ? $supplier->email : ""; ?>" required>
			</div>
		</div>
